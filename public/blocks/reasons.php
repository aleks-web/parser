    ...
    <div class="sm:container px-[0.5rem]">
        ...
        <div class="grid-reasons grid gap-4">
            ...
            <div class="<?= $item ?> bg-[#F2F6FF]">
                <img src="<?= ASSETS_URL ?>/img/reasons/1.svg" alt="num-1" class="<?= $img ?>" loading="lazy" decoding="async">
            ...
            <div class="<?= $item ?> bg-[#EDEBF0]">
                ...
                <img src="<?= ASSETS_URL ?>/img/reasons/2.svg" alt="num-2" class="<?= $img ?>" loading="lazy" decoding="async">
            ...
            <div class="<?= $item ?> bg-[#F7F7F7]">
                ...
                <div class="flex flex-wrap gap-5 items-center justify-center w-full relative z-10 s:justify-between">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-5">
                        <img src="<?= ASSETS_URL ?>/img/reasons/pay/MasterCard.svg" alt="MasterCard" loading="lazy" decoding="async">
                        <img src="<?= ASSETS_URL ?>/img/reasons/pay/Visa.svg" alt="Visa" loading="lazy" decoding="async">
                        <img src="<?= ASSETS_URL ?>/img/reasons/pay/Mir.svg" alt="Mir" loading="lazy" decoding="async">
                        <img src="<?= ASSETS_URL ?>/img/reasons/pay/sberpay.svg" alt="sberpay" loading="lazy" decoding="async">
                        <img src="<?= ASSETS_URL ?>/img/reasons/pay/sbp.svg" alt="sbp" loading="lazy" decoding="async">
                    </div>
                </div>
            ...
            <div class="<?= $item ?> bg-[#FFEFC3]">
                ...
                <img src="<?= ASSETS_URL ?>/img/reasons/3.svg" alt="num-4" class="<?= $img ?>" loading="lazy" decoding="async">
            ...
            <div class="<?= $item ?> bg-[#E0FFED]">
                ...
                <img src="<?= ASSETS_URL ?>/img/reasons/4.svg" alt="num-5" class="<?= $img ?>" loading="lazy" decoding="async">
            ...
            <div class="<?= $item ?> border-2 border-[#286CFD] flex items-center justify-center">
                <img src="<?= ASSETS_URL ?>/img/reasons/empty-logo.png" class="w-[200px]" alt="empty-logo" loading="lazy" decoding="async">
            </div>
